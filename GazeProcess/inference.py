        ...
        for _, _, files in os.walk(self.img_path):
            ...
            for img in files:
                ...
                with torch.no_grad():
                    ...
                    scanpaths = self.summary(samples).cpu().numpy()   #[y,x]
                    ...
                    if self.if_plot:
                        ...
                        plot_scanpaths_1(scanpaths, img_path, length_tensor.numpy(), save_path=self.output_path)


if __name__ == '__main__':
    parser = ArgumentParser(description='ScanDMM')
    parser.add_argument('--model', default='D:\csx\ScanPath\ScanDMM-master\AOI600v2_2-\model_lr-3e-05_bs-64_epoch-130.pkl', type=str,
                        help='model path, default = ./model/model_lr-0.0003_bs-64_epoch-435.pkl')
    parser.add_argument('--inDir', default='D:\csx\ScanPath\AOI_600v2\\333', type=str,
                        help='image path, default = ./demo/input')
    parser.add_argument('--outDir', default='D:\csx\ScanPath\AOI\\newgraph\predict_scanpath\\negative', type=str,
                        help='output path, default = ')
    parser.add_argument('--n_scanpaths', default=20, type=int,
