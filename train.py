...
class Train():
    ...
    def prepare_train_data(self):
        ...
        max_scanpath_length = _info['max_scan_length']
        image_index = np.zeros((num_scanpath))

        scanpath_set = np.zeros([num_scanpath, max_scanpath_length, 3])
        ...
        dic['sequence_lengths'] = torch.tensor(scanpath_length)
    ...
    def run(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            line = "[training epoch %04d]  %.4f \t\t\t\t(dt = %.3f sec)" % (epoch, epoch_nll / self.N_time_slices, epoch_time)
            with open(self.args.save_root+"loss.txt",'a',newline='') as file:
                file.write(line + '\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='D:\csx\ScanPath\ScanDMM-master\PM_ablation\ED+TOP13\dataset\AOI600v2_3-.pkl', type=str,
    ...
    parser.add_argument('--save_root', default='D:\csx\ScanPath\ScanDMM-master\PM_ablation\ED+TOP13\model\AOI600v2_3-\\', type=str,
